...
vts_shopbuy={
  ...
  else
  {
	...
	if (vtsarmaversion>2) then
	{
		...
		if (_buytitemtype==131072 or _buytitemtype==616 or _buytitemtype==619 or _buytitemtype==401 or _buytitemtype==301 or _buytitemtype==620 or _buytitemtype==201 or _buytitemtype==101 or _buytitemtype==621) then
		{
